...
export default {
  data() {
    return {
      activeTab: 1,
      phoneNumber: '+234-90-9119-0644',
      email: 'francemma20@gmail.com',
      tech: [
        {
          id: 1,
          name: 'HTML',
      ...
      tools: [
        ...
        },
        {
          id: 4,
          name: 'Firebase',
          imageUrl: 'https://firebase.google.com/static/downloads/brand-guidelines/PNG/logo-vertical.png',
          status: 'Database'
        },
      ]
    };
