    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          name: 'To-do list',
          imageUrl: 'todolist',
          status: 'My to-do list website simplifies task management. You can create, organize, and track tasks with due dates, collaborate with others, and stay productive from any device ',
          tech: 'VueJS 3, Sass',
          github: 'https://github.com/Mightbesad/To-do-list/',
          demo: 'https://mightbesad.github.io/'
        },
        {
          id: 3,
          name: 'Product card',
          imageUrl: 'productcard',
          status: 'A simple product card UI ',
          tech: 'HTML, CSS',
          github: 'https://github.com/Mightbesad/NIKE-LEBRON/',
          demo: 'https://mightbesad.github.io/NIKE-LEBRON/'
        },
        {
          id: 4,
          name: 'Movies-Genie',
